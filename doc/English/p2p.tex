...
\begin{tikzpicture}
%---------------------------Stream--------------------------
\umlclass[x=3, y=5, anchor=north]{Stream}{-_server_in_buf : dictionary \\+ip\\+port}{-callback()\\+get_server_address()\\ +add_node()\\+clear_in_buff()\\+remove_node()\\+get_node_by_server()\\+add_message_to_out_buff()\\+read_in_buf()\\+send_messages_to_node()\\+send_out_buf_messages()}

%--------------------------Packet Factory----------
\umlclass[x=-3, y=0, anchor=north]{Packet Factory}{}{+parse\_buffer()\\+new\_reunion\_packet()\\+new\_advertise\_packet( )\\+new_join_packet()\\+new\_register\_packet()\\+new_message_packet()}

%----------------------------Peer--------------------------
\umlclass[x=0, y=-6, anchor=north]{Peer}{}{+start_user_interface()\\+handle_user_interface_buffer()\\+run()\\+run_reunion_daemon()\\+send_broadcast_packet()\\+handle_packet()\\__check_registered\\- __handle_advertise_packet()\\- __handle_register_packet()\\-__check_neighbour()\\-  __handle_message_packet()\\-  __handle_reunion_packet()\\-__handle_join_packet()\\- __get_neighbour()}
%-----------------------------------------------------------
...
%------------------------------------------------------------------------
%----------------------------Packet-----------------------------------------
\umlclass[x=-4, y=-8, anchor=north]{Packet}{- _buf: bytearray}{+ get\_header()\\+ get\_version()\\+ get\_type()\\+ get\_length()\\+ get\_body()\\+ get_buf()\\+ get_source_server_ip()\\+get_source_server_port()\\+get_source_server_address()}
%----------------------------Reunion----------------------------------------
...
\begin{tikzpicture}
%----------------------------User Interface---------------------------------
\umlclass[x=0, y=0, anchor=north]{userInterface}{+buffer: byte}{+run()}
%----------------------------Semi Node---------------------------------
...
%----------------------------Node--------------------------------------------
\umlclass[x=0, y=-5, anchor=north]{Node}{-server_ip\\-server_port\\out_buff: byte}{+ send_message()\\+add_message_to_out_buff()\\+close()\\+get_sever_address()\\+parse_ip()\\+parse_port()}
\end{tikzpicture}
\clearpage
\section{Objects}
